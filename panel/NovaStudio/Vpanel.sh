...
echo -e "${CYAN}======================================${NC}"
echo -e "      ${YELLOW}vPanel Pro Auto Installer${NC}"
echo -e "${CYAN}======================================${NC}"
echo ""
...
REPO="https://github.com/nobita329/vpanel-pro.git"
DIR="vpanel-pro"
...
echo -e "${CYAN}[2/4]${NC} Preparing vPanel Pro repository..."

if [ -d "$DIR/.git" ]; then
    echo -e "${YELLOW}      Existing vPanel Pro directory found.${NC}"
    cd "$DIR"
    ...
    echo -e "${YELLOW}      vPanel Pro not found locally. Cloning...${NC}"
...
echo -e "${CYAN}[4/4]${NC} Running vPanel installer..."
...
echo ""
echo -e "${CYAN}======================================${NC}"
echo -e "${GREEN}      [✔] vPanel Pro Setup Completed${NC}"
echo -e "${CYAN}======================================${NC}"
